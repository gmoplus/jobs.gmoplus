...
define('RL_DBUSER', 'gmoplus_jobsuser');
define('RL_DBPASS', 'gmoplus_jobsuser1234');
define('RL_DBNAME', 'gmoplus_jobs');
define('RL_DBPREFIX', 'fl_');

// system paths
define('RL_DIR', '');
define('RL_ROOT', '/home/gmoplus/jobs.gmoplus.com' . RL_DS . RL_DIR);
...
define('RL_CACHE', RL_TMP . 'cache_519952200' . RL_DS);

// system URLs
define('RL_URL_HOME', 'https://jobs.gmoplus.com/');
...
define('RL_SETUP', 'JGxpY2Vuc2VfZG9tYWluID0gImpvYnMuZ21vcGx1cy5jb20iOyRsaWNlbnNlX251bWJlciA9ICJGTDZGNjhCRFdYRzAiOw==');
/* END CODE */
